    ...
    <div>
        <a onClick={handleNavigate} className='w-[13rem] items-center text-white overflow-hidden grid grid-cols-5 font-bigShoulders border-none cursor-pointer font-extrabold absolute z-10 left-14 top-3'>
              ...
              <div className=' bg-black flex justify-center items-center font-bigShoulders800 col-span-4 h-[3.5rem] lg:h-[4rem] p-1 place-items-center'>
                <span className='tracking-[1px] uppercase'>Back to home</span>
              </div>
              
            </a>
        <Map/>
        <section className=' bg-black px-6 py-16'>
          <div className='grid md:grid-cols-2 lg:max-w-[900px] lg:mx-auto xl:max-w-[1178px]'>
            <h1 className='text-5xl uppercase font-black font-bigShoulders  text-white pb-10'>our location</h1>
            <div>
              <h2 className='text-4xl uppercase font-black font-bigShoulders text-gold pb-6'>99 king street</h2>
              <p className='capitalize font-outfit font-light text-[1.125rem]  text-white leading-7 pb-6'>Newport <br/>RI 02840 <br/>
              united states of america.
              </p>
              <p className='font-outfit text-xl font-light text-white'>Our newly opened gallery is located near the Edward King House on 99 King Street, the Modern Art Gallery is free to all visitors and open seven days a week from 8am to 9pm.</p>
            </div>
          </div>
          
        </section>
        <footer className='bg-gold md:pb-[5rem]'>
          <div className='py-12 mx-6 grid md:grid-cols-4 md:py-10 md:gap-6 lg:max-w-[900px] lg:mx-auto xl:max-w-[1178px]'>
              <div className='flex justify-start items-baseline'>
                  <img src={logoDark} alt="dark logo" className='w-[10rem] pb-10 md:pb-0 md:pt-[10px]' />
              </div>
              <div className='md:col-start-2 md:col-end-4 justify-start items-center md:items-baseline'>
                  <p className='text-black font-outfit font-light text-[1.125rem] leading-7 pb-10 md:pb-0'>The Modern Art Gallery is free to all visitors and open seven days a week from 8am to 9pm. Find us at 99 King Street, Newport, USA.</p>
              </div>
